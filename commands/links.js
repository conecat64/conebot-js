...
module.exports = {
    ...
    async execute(interaction) {
        ...
        let embed = new EmbedBuilder()
            ...
            .setTitle(emojis[gameData.emoji] + 'Game information')
